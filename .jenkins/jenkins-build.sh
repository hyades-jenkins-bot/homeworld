...
echo "mkdir -p binaries/autobuild && glass components -b hijinks.mit.edu/apt/autobuild --upload" | su jenkins -c 'HOMEWORLD_CHROOT="$HOME/autobuild-chroot" ./enter-chroot-ci.sh'
rm -rf /binaries/autobuild
mv building/binaries/autobuild /binaries
